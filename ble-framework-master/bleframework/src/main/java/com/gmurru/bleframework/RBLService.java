...
import static com.gmurru.bleframework.RBLGattAttributes.BLE_SHIELD_SERVICE;
...
public class RBLService extends Service {
    ...
    public final static UUID UUID_BLE_SHIELD_LOW_CTRL = UUID
            .fromString(RBLGattAttributes.BLE_SHIELD_LOW_CTRL);
    ...
    public boolean connect(final String address) {
        ...
        // autoConnect
        // parameter to false.
        mBluetoothGatt = device.connectGatt(this, false, mGattCallback);// them BluetoothDevice.TRANSPORT_AUTO
    ...
    public void setCharacteristicNotification(
        ...
        UUID uuid = UUID.fromString(RBLGattAttributes.CLIENT_CHARACTERISTIC_CONFIG);
